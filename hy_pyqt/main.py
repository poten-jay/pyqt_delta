...
# Assuming 'function.py' provides the xyz_button class
...
class MyApp(QWidget):
    ...
    def button(self):
        ...
        imagePath = '/workspace/pyqt_delta/eth.png'
        ...
        self.btnZUp.setIcon(QIcon('/workspace/pyqt_delta/eth.png'))  # 이미지 경로 설정
